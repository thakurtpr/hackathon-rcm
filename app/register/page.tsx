  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-gray-950 p-4 font-sans selection:bg-indigo-500/30 transition-colors duration-500">
      ...
      <div className="w-full max-w-lg relative">
        {/* Card */}
        <div className="bg-gray-50 dark:bg-gray-900 shadow-2xl dark:shadow-none border border-gray-200 dark:border-gray-800 rounded-3xl overflow-hidden backdrop-blur-sm transition-colors duration-500">
          <div className="p-8 pb-4">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">Create Your Account</h2>
            <p className="mt-2 text-gray-500 dark:text-gray-400 font-medium">Join our AI-powered student loan platform today.</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-8 pt-4 space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <User className="h-4 w-4 text-gray-400 group-focus-within:text-indigo-600 dark:group-focus-within:text-indigo-400 transition-colors" />
                </div>
                <input
                  {...register('fullName')}
                  type="text"
                  placeholder="John Doe"
                  className={`block w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950/50 text-gray-950 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 dark:focus:ring-indigo-500/20 focus:border-indigo-500/50 dark:focus:border-indigo-500/50 transition-all duration-200 ${errors.fullName ? 'border-red-500/50 ring-red-500/10' : ''}`}
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <Calendar className="h-4 w-4 text-gray-400 group-focus-within:text-indigo-600 dark:group-focus-within:text-indigo-400 transition-colors" />
                  </div>
                  <input
                    {...register('dob')}
                    type="date"
                    className={`block w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950/50 text-gray-950 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 dark:focus:ring-indigo-500/20 focus:border-indigo-500/50 dark:focus:border-indigo-500/50 transition-all duration-200 ${errors.dob ? 'border-red-500/50 ring-red-500/10' : ''}`}
                  />
                </div>
          ...
          <div className="p-8 pt-2 text-center">
            <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">
              ...
              <Link
                href="/login"
                className="text-indigo-600 dark:text-indigo-400 font-bold hover:text-indigo-500 dark:hover:text-indigo-300 hover:underline transition-colors decoration-2 underline-offset-4"
              >
                Log In
              </Link>
            </p>
